...
def set(models, optim_str, lr):
    ...
    """
    warnings.warn(
        "scitex_ai.optim.set is deprecated. Use scitex_ai.optim.set_optimizer instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def get(optim_str):
    ...
    """
    warnings.warn(
        "scitex_ai.optim.get is deprecated. Use scitex_ai.optim.get_optimizer instead.",
        DeprecationWarning,
        stacklevel=2,
    )
