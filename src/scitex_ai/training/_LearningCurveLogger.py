...
Functionality:
    ...
    - Delegates plotting to scitex_ai.plt.plot_learning_curve for consistency
...
Output:
    - Learning curve plots via scitex_ai.plt.plot_learning_curve
...
class LearningCurveLogger:
    ...
    def plot_learning_curves(
        ...
        Delegates to scitex_ai.plt.plot_learning_curve for consistent plotting.
        ...
        """
        from scitex_ai.plt import plot_learning_curve
