...
plotting functions in scitex_ai.plt to maintain DRY principle.
...
try:
    ...
    from scitex_ai.plt.plot_pre_rec_curve import plot_pre_rec_curve as pre_rec_auc
    from scitex_ai.plt.plot_roc_curve import plot_roc_curve as roc_auc
    from scitex_ai.plt.stx_conf_mat import stx_conf_mat as conf_mat
...
class Plotter:
    ...
    def create_feature_importance_plot(
        ...
        try:
            ...
            from scitex_ai.plt import plot_feature_importance as plot_fi
