...
class MetricsMixin:
    ...
    def calculate_metrics(
        ...
        if y_proba is not None:
            try:
                from scitex_ai.metrics import calc_pre_rec_auc, calc_roc_auc
    ...
    def _extract_and_save_feature_importance(
        ...
        try:
            from scitex_ai.feature_selection import extract_feature_importance
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        if feature_importances_list:
            from scitex_ai.feature_selection import aggregate_feature_importances
