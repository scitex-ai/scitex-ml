...
Continuation of [16_metrics.md](16_metrics.md). All functions live in `scitex_ml.metrics` and return the same dict shape (`{"metric", "value", "fold", ...}`) when applicable.
...
See [19_feature-selection.md](19_feature-selection.md) for the higher-level `extract_feature_importance()` helper.
