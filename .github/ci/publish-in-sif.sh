...
# (project=scitex-ml, owner=ywatanabe1989, repo=scitex-ml,
...
TMPDIR="/tmp/publish-scitex_ml-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-ml dist/* uploaded to PyPI via manual OIDC trusted publishing"
