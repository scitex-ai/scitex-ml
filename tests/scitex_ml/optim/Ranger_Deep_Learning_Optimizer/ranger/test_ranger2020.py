"""Smoke test for scitex_ml.optim.Ranger_Deep_Learning_Optimizer.ranger.ranger2020.
...
def test_module_imports_under_expected_dotted_name():
    ...
    # Arrange
    target = "scitex_ml.optim.Ranger_Deep_Learning_Optimizer.ranger.ranger2020"
    # Act
