...
"""
Comprehensive tests for scitex_ml.sklearn.clf module.
...
class TestGBPipeline:
    ...
    def test_gb_pipeline_is_pipeline(self):
        ...
        from scitex_ml.sklearn.clf import GB_pipeline
...
class TestModuleIntegration:
    ...
    def test_pipeline_functions_callable(self, pipeline_func):
        ...
        from scitex_ml.sklearn import clf
...
class TestErrorHandling:
    ...
    def test_pipeline_methods_exist(self):
        ...
        from scitex_ml.sklearn.clf import GB_pipeline, rocket_pipeline
