"""Auto-generated smoke test for scitex_ml.metrics._calc_seizure_prediction_metrics.
...
def test_module_imports():
    ...
    importlib.import_module('scitex_ml.metrics._calc_seizure_prediction_metrics')
