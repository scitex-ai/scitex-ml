"""Auto-generated smoke test for scitex_ml.classification.examples.timeseries_cv_demo.
...
def test_module_imports():
    ...
    importlib.import_module('scitex_ml.classification.examples.timeseries_cv_demo')
