"""Auto-generated smoke test for scitex_ml.classification.reporters.reporter_utils.data_models.
...
def test_module_imports():
    ...
    importlib.import_module('scitex_ml.classification.reporters.reporter_utils.data_models')
