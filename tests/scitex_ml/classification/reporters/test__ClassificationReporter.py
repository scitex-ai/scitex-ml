"""Auto-generated smoke test for scitex_ml.classification.reporters._ClassificationReporter.
...
def test_module_imports():
    ...
    importlib.import_module('scitex_ml.classification.reporters._ClassificationReporter')
