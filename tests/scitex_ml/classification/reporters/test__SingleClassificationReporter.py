"""Smoke test for scitex_ml.classification.reporters._SingleClassificationReporter.
...
def test_module_imports_under_expected_dotted_name():
    ...
    # Arrange
    target = "scitex_ml.classification.reporters._SingleClassificationReporter"
    # Act
