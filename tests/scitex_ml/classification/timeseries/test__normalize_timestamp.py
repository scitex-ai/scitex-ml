"""Auto-generated smoke test for scitex_ml.classification.timeseries._normalize_timestamp.
...
def test_module_imports():
    ...
    importlib.import_module('scitex_ml.classification.timeseries._normalize_timestamp')
